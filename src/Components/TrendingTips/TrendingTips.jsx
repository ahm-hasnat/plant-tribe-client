  ...
  return (
    <section className="pb-20   px-4 md:px-12">
        <div className='flex gap-2 items-center justify-center mb-4'>
            <img className='w-14' src="https://i.ibb.co.com/HLyZdqNH/leaf.png" alt="" />
             <h2 className="text-3xl md:text-4xl font-bold text-center text-primary ">
         Top trending Tips </h2>
        </div>
      
      <p className="text-center text-md text-secondary mb-12 max-w-2xl mx-auto">
        Discover practical, trending advice from experienced gardeners in our community.
      </p>
...
// <a href="https://imgbb.com/"><img src="https://i.ibb.co.com/HLyZdqNH/leaf.png" alt="leaf" border="0"></a><br /><a target='_blank' href='https://imgbb.com/'>upload images</a><br />