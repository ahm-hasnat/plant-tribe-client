...
const BrowseTips = () => {
  ...
  const handleFilter = (e) => {
    ...
    //.log(selectedDifficulty);

    const filteredTips = publicTips.filter(
      (data) => data.difficulty === selectedDifficulty
    );
        ...
        {Tips.length === 0 && publicTips.length > 4 && (
          <div className="flex justify-center mt-6">
            <button
              ...
              className="btn btn-outline text-[#204e51] border-[#204e51] 
              btn-success sada hover:bg-[#f26b5e]"
            >
